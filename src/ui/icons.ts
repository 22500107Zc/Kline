...
export const ICONS: Record<string, string> = {
  ...
  play: wrap('<path d="M7 4l13 8-13 8z" fill="currentColor" stroke="none"/>'),
  pause: wrap('<path d="M8 4v16M16 4v16" stroke-width="3"/>'),
  stepBack: wrap('<path d="M18 5v14L8 12z" fill="currentColor" stroke="none"/><path d="M6 4v16"/>'),
  stepForward: wrap('<path d="M6 5v14l10-7z" fill="currentColor" stroke="none"/><path d="M18 4v16"/>'),
  skipStart: wrap('<path d="M20 5v14L9 12z" fill="currentColor" stroke="none"/><path d="M5 4v16" stroke-width="2.4"/>'),
  skipEnd: wrap('<path d="M4 5v14l11-7z" fill="currentColor" stroke="none"/><path d="M19 4v16" stroke-width="2.4"/>'),
  key: wrap('<path d="M12 4l5 8-5 8-5-8z" fill="currentColor" stroke="none"/>'),
  loop: wrap('<path d="M4 9a5 5 0 0 1 5-5h9"/><path d="M15 1l3 3-3 3"/><path d="M20 15a5 5 0 0 1-5 5H6"/><path d="M9 23l-3-3 3-3"/>'),
  sculpt: wrap('<path d="M4 20c3-1 4-4 7-6s6-2 8-5"/><circle cx="17" cy="7" r="3"/><path d="M3 21l3-1"/>'),
  render: wrap('<rect x="3" y="5" width="18" height="14" rx="1.5"/><circle cx="9" cy="11" r="2.5"/><path d="M3 17l5-4 4 3 3-2 6 4"/>'),
  uv: wrap('<rect x="3" y="3" width="18" height="18"/><path d="M3 9h18M3 15h18M9 3v18M15 3v18"/>'),
  proportional: wrap('<circle cx="12" cy="12" r="9" stroke-dasharray="3 3"/><circle cx="12" cy="12" r="3.5" fill="currentColor" stroke="none"/>'),
  snap: wrap('<path d="M5 5h4v4H5zM15 15h4v4h-4z"/><path d="M9 7h6a2 2 0 0 1 2 2v6"/>'),
  bevel: wrap('<path d="M4 20V9l5-5h11v11l-5 5z"/><path d="M4 9h11v11"/>'),
  boolean: wrap('<circle cx="9.5" cy="12" r="6"/><circle cx="14.5" cy="12" r="6"/>'),
